...
export class PreferencesComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.appContainer = this.appRef.components[0].location.nativeElement.querySelector('.mdf-app');
	...
	ngAfterViewInit(): void {
		...
		this.gradientSwatches = document.querySelectorAll('#gradients .mdf-color');
	}
